...
#Supplementary Figure 2
    ...
    pdf("~/hist_ddRAD_LB.pdf",10,10)
    print(hist_ddRAD_LB)
    dev.off() 
    
    pdf("~/hist_ddRAD_SB.pdf",10,10)
    print(hist_ddRAD_SB)
    dev.off() 
    
    pdf("~/hist_ddRAD_PL.pdf",10,10)
    print(hist_ddRAD_PL)
    dev.off() 
    
    pdf("~/hist_ddRAD_highest.pdf",10,10)
...
#Supplementary Figure 3:
    ...
    #Export all plots in .pdf and put them together in Inkscape
    pdf("~/hist_WGS_LB.pdf",10,10)
    print(hist_WGS_LB)
    dev.off() 
    
    pdf("~/hist_WGS_SB.pdf",10,10)
    print(hist_WGS_SB)
    dev.off() 
    
    pdf("~/hist_WGS_PL.pdf",10,10)
    print(hist_WGS_PL)
    dev.off() 
    
    pdf("~/hist_WGS_highest.pdf",10,10)
