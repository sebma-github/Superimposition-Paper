...
You can use **Superimposition-Paper/Raw_Data/methylation_data/Position_CpGvsRADSNP_0p2_peak30k.csv** as an example to understand the script.

Sample names and orders can be found at **Superimposition-Paper/Raw_Data/methylation_data/samplerecapdf_samplenames_27.csv**. 
